"""
Britannia Processor - Interactive version that asks questions during processing
...
def process_britannia_sales_interactive(input_file, reference_file, output_file, 
                                 column_mapping=None, selected_state=None,
                                 processing_cache=None, pending_question_callback=None):
    """
    Process Britannia sales orders - Interactive version that asks questions during processing.
    ...
    # Column mapping (auto-detect) - Britannia uses same as HUL
    ...
    # Detect GST columns for Britannia: CGST %, SGST / UGST %, IGST %
    cgst_col = None
    sgst_col = None
    igst_col = None
    for col in df.columns:
    ...
    # Parse dates with dayfirst=True (Britannia-specific)
