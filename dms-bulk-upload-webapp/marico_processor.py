...
def process_marico_sales(input_file, reference_file, output_file, column_mapping=None, selected_state=None):
    """
    ...
    # Detect due_date and GST columns for Marico
    due_date_col = None
    cgst_rate_col = None
    sgst_rate_col = None
    igst_rate_col = None
    ...
    # Parse dates with dayfirst=True for Marico
