"""
Unicharm Processor - Interactive version that asks questions during processing
...
def process_unicharm_sales_interactive(input_file, reference_file, output_file, 
    ...
    """
    Process Unicharm sales orders - Interactive version that asks questions during processing.
    ...
    # Load sales file with multi-header (Unicharm-specific)
    ...
    # Detect GST columns for Unicharm
    ...
    # Parse dates with dayfirst=True (Unicharm-specific)
    ...
    # Calculate due_date (10 days from order_date) - Unicharm-specific
